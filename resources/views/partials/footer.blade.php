      ...
      <div class="row row-eq-height row-mob-full" data-gutter="60">
        <div class="col-md-3">
          <div class="theme-footer-section theme-footer-">
            <a class="theme-footer-brand _mb-mob-30" href="#">
              <img src="{{asset('frontend/img/logo-black.png')}}" alt="Image Alternative text" title="Image Title"/>
            </a>
        ...
        <div class="col-md-4">
          <div class="theme-footer-section theme-footer-section-subscribe bg-grad _mt-mob-30">
            <div class="theme-footer-section-subscribe-bg" style="background-image:url(frontend/img/footer/footer_subscribe_bg.png);"></div>
